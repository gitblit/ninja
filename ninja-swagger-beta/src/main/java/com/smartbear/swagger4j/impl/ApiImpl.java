...
public class ApiImpl implements Api {
    ...
    @Override
    public Operation addOperation(String nickName, String httpMethod) {
        assert nickName != null && httpMethod != null : "operation can not be null and must have a nickname";
        assert getOperation(nickName ) == null : "operation with nickName [" + nickName + "] already exists";

        synchronized (operations) {
            OperationImpl result = new OperationImpl(this, nickName, httpMethod);
